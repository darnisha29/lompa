...
const Dropdown: React.FC<DropdownProps> = ({ items = [], onSelect, placeholder = "Select an option" }) => {
  ...
  return (
    <div className="relative inline-block text-left rounded-none ">
      <button
        onClick={() => setOpen(!open)}
        className="flex  gap-20  items-center px-4 py-1.5 border border-gray-300 rounded-none cursor-pointer bg-white hover:bg-gray-100"
      >
