...
const OrderTabs: React.FC<OrderTabsProps> = ({ tabs, onTabChange,  rounded = false }) => {
  ...
  return (
    <div className="w-full">
      <div
        className={`flex  ${rounded ? " gap-5 rounded-md overflow-hidden" : "border-b border-gray-300"
          }`}
      >
        {tabs.map((tab, index) => (
          <button
            ...
            className={`flex-1 py-2 px-4 text-center transition-colors duration-300 ${selectedTab === index
